...
HexDigits = [0x3f, 0x06, 0x5b, 0x4f, 0x66, 0x6d, 0x7d,
             ...
             0x6E, 0x5B, 0x00, 0x40, 0x63, 0x08, 0x01, 0x63, 0x6b, 0x77]
## HexDigit list# above, to input into Show()s: 0-9,10-35, 36   , 37,   38,   39,       40,      41,        42,               43
## Corresponding Display:                       0-9, A-z*, blank, dash, star, '_', topdash, topcircle, topcircle_underlined, 8noBottom
...
##
##  HGFEDCBA
##  00001000 (binary) = topdash(from 2nd segment diagram above) = 0x08 (hex) = 40 (Correesponding HexDigit list defined above, to input into Show functions to use)
